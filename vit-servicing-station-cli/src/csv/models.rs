...
impl TryInto<community_advisors_reviews::AdvisorReview> for AdvisorReview {
    ...
    fn try_into(self) -> Result<community_advisors_reviews::AdvisorReview, Self::Error> {
        Ok(community_advisors_reviews::AdvisorReview {
            ...
            feasibility_note: Some(self.feasibility_note),
            feasibility_rating_given: Some(self.feasibility_rating_given),
            impact_alignment_note: Some(self.impact_alignment_note),
            impact_alignment_rating_given: Some(self.impact_alignment_rating_given),
            auditability_note: Some(self.auditability_note),
            auditability_rating_given: Some(self.auditability_rating_given),
            rating_given: None,
            ranking: Some(match (self.excellent, self.good, self.filtered_out) {
