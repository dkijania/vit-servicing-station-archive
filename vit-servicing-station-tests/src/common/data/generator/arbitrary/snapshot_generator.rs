...
impl ArbitrarySnapshotGenerator {
    ...
    fn gen_single_fund(&mut self) -> Fund {
        ...
        Fund {
            ...
            results_url: Some(format!("http://localhost/fund/{id}/results/")),
            survey_url: Some(format!("http://localhost/fund/{id}/survey/")),
        }
    }
    ...
    pub fn challenges_with_fund_id(&mut self, fund_id: i32) -> Vec<Challenge> {
        ...
        vec![
            ...
            Challenge {
                internal_id: Some(second_challenge.internal_id),
    ...
    pub fn challenge_with_fund_id(&mut self, fund_id: i32) -> Challenge {
        ...
        Challenge {
            internal_id: Some(challenge.internal_id),
            id: id.abs(),
            challenge_type: ChallengeType::CommunityChoice,
    ...
    pub fn review_with_proposal_id(&mut self, proposal_id: i32) -> AdvisorReview {
        ...
        AdvisorReview {
            ...
            impact_alignment_rating_given: Some(review.impact_alignment_rating_given),
            impact_alignment_note: Some(review.impact_alignment_note),
            feasibility_rating_given: Some(review.feasibility_rating_given),
            feasibility_note: Some(review.feasibility_note),
            auditability_rating_given: Some(review.auditability_rating_given),
            auditability_note: Some(review.auditability_note),
            ranking: Some(review.ranking),
            rating_given: None,
            note: None,
            tag: None,
        }
