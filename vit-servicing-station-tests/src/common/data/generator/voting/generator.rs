...
impl ValidVotePlanGenerator {
    ...
    pub fn build(&mut self, template_generator: &mut dyn ValidVotingTemplateGenerator) -> Snapshot {
        ...
        let challenges: Vec<Challenge> = std::iter::from_fn(|| {
            ...
            Some(Challenge {
                internal_id: Some(challenge_data.internal_id),
        ...
        let reviews: Vec<AdvisorReview> = std::iter::from_fn(|| {
            ...
            Some(AdvisorReview {
                ...
                impact_alignment_rating_given: Some(review_data.impact_alignment_rating_given),
                impact_alignment_note: Some(review_data.impact_alignment_note),
                feasibility_rating_given: Some(review_data.feasibility_rating_given),
                feasibility_note: Some(review_data.feasibility_note),
                auditability_rating_given: Some(review_data.auditability_rating_given),
                auditability_note: Some(review_data.auditability_note),
                ranking: Some(review_data.ranking),
                rating_given: None,
                note: None,
                tag: None,
            })
