...
pub struct AdvisorReview {
    ...
    pub ranking: Option<ReviewRanking>,
...
impl Insertable<community_advisors_reviews::table> for AdvisorReview {
    ...
    type Values = (
        ...
        diesel::dsl::Eq<community_advisors_reviews::impact_alignment_rating_given, Option<i32>>,
        diesel::dsl::Eq<community_advisors_reviews::impact_alignment_note, Option<String>>,
        diesel::dsl::Eq<community_advisors_reviews::feasibility_rating_given, Option<i32>>,
        diesel::dsl::Eq<community_advisors_reviews::feasibility_note, Option<String>>,
        diesel::dsl::Eq<community_advisors_reviews::auditability_rating_given, Option<i32>>,
        diesel::dsl::Eq<community_advisors_reviews::auditability_note, Option<String>>,
        diesel::dsl::Eq<community_advisors_reviews::rating_given, Option<i32>>,
        diesel::dsl::Eq<community_advisors_reviews::ranking, Option<i32>>,
        diesel::dsl::Eq<community_advisors_reviews::note, Option<String>>,
        diesel::dsl::Eq<community_advisors_reviews::tag, Option<String>>,
    );
    ...
    fn values(self) -> Self::Values {
        (
            ...
            community_advisors_reviews::ranking.eq(self.ranking.map(|x| x as i32)),
            community_advisors_reviews::note.eq(self.note),
            community_advisors_reviews::tag.eq(self.tag),
        )
    }
}
...
pub mod test {
    ...
    pub fn get_test_advisor_review_with_proposal_id(proposal_id: i32) -> AdvisorReview {
        AdvisorReview {
            ...
            impact_alignment_rating_given: Some(0),
            impact_alignment_note: Some("impact note".to_string()),
            feasibility_rating_given: Some(0),
            feasibility_note: Some("feasibility note".to_string()),
            auditability_rating_given: Some(0),
            auditability_note: Some("auditability".to_string()),
            ranking: Some(ReviewRanking::Good),
            rating_given: None,
            note: None,
            tag: None,
        }
