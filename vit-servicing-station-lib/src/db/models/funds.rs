...
impl Insertable<funds::table> for Fund {
    type Values = (
        ...
        diesel::dsl::Eq<funds::results_url, Option<String>>,
        diesel::dsl::Eq<funds::survey_url, Option<String>>,
    );
    ...
    pub fn get_test_fund(fund_id: Option<i32>) -> Fund {
        ...
        Fund {
            ...
            registration_snapshot_time: (OffsetDateTime::now_utc() + Duration::days(3))
                .unix_timestamp(),
            next_registration_snapshot_time: Some((OffsetDateTime::now_utc() + Duration::days(30))
                .unix_timestamp()),
            ...
            results_url: Some(format!("http://localhost/fund/{FUND_ID}/results/")),
            survey_url: Some(format!("http://localhost/fund/{FUND_ID}/survey/")),
        }
    }
