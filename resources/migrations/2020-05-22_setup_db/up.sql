...
CREATE TABLE IF NOT EXISTS "funds" (
	...
	"next_registration_snapshot_time" 	BIGINT DEFAULT 0,
	"voting_power_threshold"	BIGINT,
	"fund_start_time"	BIGINT,
	"fund_end_time"	BIGINT,
	"next_fund_start_time"	BIGINT,
	"insight_sharing_start"	BIGINT DEFAULT 0,
	"proposal_submission_start"	BIGINT DEFAULT 0,
	"refine_proposals_start"	BIGINT DEFAULT 0,
	"finalize_proposals_start"	BIGINT DEFAULT 0,
	"proposal_assessment_start"	BIGINT DEFAULT 0,
	"assessment_qa_start"	BIGINT DEFAULT 0,
	"snapshot_start"	BIGINT DEFAULT 0,
	"voting_start"	BIGINT DEFAULT 0,
	"voting_end"	BIGINT DEFAULT 0,
	"tallying_end"	BIGINT DEFAULT 0,
	"results_url"	VARCHAR,
	"survey_url"	VARCHAR,
	PRIMARY KEY("id")
);
